function output=SSScalart96(signal,fs,IS)

% output=SSSCALART96(signal,fs,IS)
% Spectral Subtraction based on tracking a priori SNR using
% Decision-Directed method, proposed by Scalart et al 96. In this method it
% is assumed that SNRpost=SNRprior +1. based on this the power spectral
% subtraction can be adapted to a model like Ephraims model in which we
% have a gain function which is a function of a priori SNR and a priori SNR
% is being tracked using Decision Directed method.
